...
export default function RegisterPage() {
  ...
  async function onSubmit(data: RegisterFormData) {
    ...
    try {
      ...
      if (firebaseError.code === "auth/email-already-in-use") {
        toast.error(t("auth.register.emailInUse"));
      } else {
  ...
  async function handleGoogleSignIn() {
    ...
    try {
      ...
      toast.error(`${t("auth.register.error")}: ${firebaseError.code || "Unknown error"}`);
    } finally {
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          >
            ...
            {isGoogleLoading ? t("auth.register.loading") : t("auth.register.signUpWithGoogle")}
          </Button>
